...
const Portofolio = () => {
    return (
        <div id='portofolio' className='flex flex-col justify-center items-center mt-40'>
            ...
            <div className="project mt-20 flex flex-col gap-20 p-12 md:p-0">
                <div className="flex flex-col md:flex-row gap-4 w-full justify-around  text-2xl">
                    <div className="image-1 md:w-[40%] flex flex-col gap-3 ">
                    ...
                    <div className="image-2 md:w-[40%] flex flex-col gap-3">
